...
TRANSLATIONS: dict[str, dict[str, str]] = {
    "en": {
        ...
        "login_throttled": "Too many failed attempts — wait a few minutes and try again",
        ...
        "request_creation_failed": "Could not create request — please try again",
        ...
        "setup_mail_heading": "Email delivery (optional)",
        "setup_mail_hint": "Leave blank to configure later — until then, emails are only logged, not sent.",
        "smtp_host": "SMTP host",
        "smtp_port": "SMTP port",
        ...
        "invalid_webpage": "Invalid web address — use an http:// or https:// link",
        "ad_effects_failed": "{count} Active Directory action(s) from this workflow did not go through",
        "ad_effects_retried": "{ok} succeeded, {failed} still failing",
        "retry": "Retry",
        "confirm": "Confirm",
        "add_row": "+ Add",
        "floorplan_too_large": "Floor plan image is too large (max {max_size_mb} MB)",
        "setup_invalid_email": "Enter a valid email address",
        "setup_password_too_short": "Password must be at least 12 characters",
        "setup_confirm_password": "Confirm Password",
        "setup_passwords_differ": "The two passwords do not match",
        "ad_fields_readonly": "Active Directory is unreachable — AD-backed fields are read-only for now. Local fields still save.",
        "move_up": "Move up",
        "move_down": "Move down",
        "token_expired_help": "Ask the person who sent you this link to re-send it — the new link will work straight away.",
        "too_many_attempts_help": "Wait for the current code to expire, then request a new one. If you are stuck, contact the person who sent you this link.",
        "unexpected_error": "Something went wrong — please try again, or contact IT if it persists",
        "ad_operation_failed": "The Active Directory operation failed — check your credentials and try again",
        "invalid_yaml": "Invalid YAML: {error}",
        "no_workflow_selected": "No workflow selected. Add one to begin.",
        "warnings_count": "\u26a0 {count} issue(s) — click to view",
        ...
        "assignee_anyone_with_role": "Anyone with role: {role}",
        "assignee_anyone_with_permission": "Anyone with permission: {permission}",
        "assignee_requester_long": "The person who created the request",
        "assignee_target_long": "The person this request is about",
        "recipient_role": "Role: {role}",
        "recipient_permission": "Permission: {permission}",
        "event_when_submitted": "When submitted",
        "event_when_approved": "When approved",
        "event_when_rejected": "When rejected",
        "event_when_corrections": "When changes are requested",
        "event_when_completed": "When completed",
        "event_when_cancelled": "When cancelled",
        ...
        "confirm_reset_defaults": "Reset every setting in this section to its default? Your saved values are lost.",
        "confirm_reset_workflows": "Reset ALL workflows to defaults? Every workflow, step and field you configured is lost.",
        "confirm_delete_pin": "Delete the pin \"{label}\"?",
        "confirm_revoke_availability": "Revoke this availability window?",
        "floorplan_revoke": "Revoke",
        ...
        "download_failed": "Download failed — please try again, or contact IT if it persists",
        "download_failed_missing": "Download failed — the file is missing on the server",
        ...
        "kind_asset": "Asset",
        "kind_other": "Other",
        "delete_confirm": "Permanently delete this retired resource and its past bookings? This cannot be undone.",
        "migrate_bookings_title": "Migrate bookings of {name}",
        "migrate_bookings_hint": "This resource still has upcoming bookings. Pick a replacement resource for each one; they will be moved (and their users notified) before the resource is deleted.",
        "migrate_target": "Move to",
        "migrate_select_all": "Select a replacement resource for every booking",
        "migrate_and_delete": "Migrate & delete",
        "migrate_no_target": "No other active resource available — cancel the bookings first",
        "bookings_migrated_resource_deleted": "Bookings migrated, resource deleted",
        "note": "Note",
        "specs": "Specs",
        "cpu": "CPU",
        "ram": "RAM",
    ...
    "fr": {
        ...
        "login_throttled": "Trop de tentatives échouées — patientez quelques minutes puis réessayez",
        ...
        "request_creation_failed": "Impossible de créer la demande — veuillez réessayer",
        ...
        "setup_mail_heading": "Envoi des e-mails (optionnel)",
        "setup_mail_hint": "Laissez vide pour configurer plus tard — d'ici là, les e-mails sont seulement journalisés, pas envoyés.",
        ...
        "invalid_webpage": "Adresse web invalide — utilisez un lien http:// ou https://",
        "ad_effects_failed": "{count} action(s) Active Directory de ce workflow n'ont pas abouti",
        "ad_effects_retried": "{ok} réussie(s), {failed} toujours en échec",
        "retry": "Réessayer",
        "confirm": "Confirmer",
        "add_row": "+ Ajouter",
        "floorplan_too_large": "L'image du plan est trop volumineuse (max {max_size_mb} Mo)",
        "setup_invalid_email": "Saisissez une adresse e-mail valide",
        "setup_password_too_short": "Le mot de passe doit comporter au moins 12 caractères",
        "setup_confirm_password": "Confirmer le mot de passe",
        "setup_passwords_differ": "Les deux mots de passe ne correspondent pas",
        "ad_fields_readonly": "Active Directory est injoignable — les champs issus d'AD sont en lecture seule. Les champs locaux restent modifiables.",
        "move_up": "Monter",
        "move_down": "Descendre",
        "token_expired_help": "Demandez à la personne qui vous a envoyé ce lien de le renvoyer — le nouveau lien fonctionnera immédiatement.",
        "too_many_attempts_help": "Attendez l'expiration du code actuel, puis demandez-en un nouveau. En cas de blocage, contactez la personne qui vous a envoyé ce lien.",
        "unexpected_error": "Une erreur est survenue — réessayez, ou contactez l'informatique si cela persiste",
        "ad_operation_failed": "L'opération Active Directory a échoué — vérifiez vos identifiants et réessayez",
        "invalid_yaml": "YAML invalide : {error}",
        "no_workflow_selected": "Aucun workflow sélectionné. Ajoutez-en un pour commencer.",
        "warnings_count": "\u26a0 {count} problème(s) — cliquez pour voir",
        "add_notification_rule": "+ Ajouter une règle de notification",
        "notification_event": "événement",
        "notification_step": "étape",
        "notification_recipients": "destinataires",
        "unknown_value": "Inconnu : {value}",
        "fields": "Champs",
        "required": "Obligatoire",
        "add_field": "+ Ajouter un champ",
        "ok": "OK",
        "configuration_warnings": "Avertissements de configuration",
        "confirm_discard_changes": "Abandonner les modifications non enregistrées ?",
        "discard": "Abandonner",
        "keep_editing": "Continuer l'édition",
        "assignee_anyone_with_role": "Toute personne ayant le rôle : {role}",
        "assignee_anyone_with_permission": "Toute personne ayant la permission : {permission}",
        "assignee_requester_long": "La personne qui a créé la demande",
        "assignee_target_long": "La personne concernée par la demande",
        "recipient_role": "Rôle : {role}",
        "recipient_permission": "Permission : {permission}",
        "event_when_submitted": "À la soumission",
        "event_when_approved": "À l'approbation",
        "event_when_rejected": "Au rejet",
        "event_when_corrections": "À la demande de modifications",
        "event_when_completed": "À la clôture",
        "event_when_cancelled": "À l'annulation",
        ...
        "confirm_reset_defaults": "Réinitialiser tous les paramètres de cette section ? Vos valeurs enregistrées seront perdues.",
        "confirm_reset_workflows": "Réinitialiser TOUS les workflows ? Chaque workflow, étape et champ configuré sera perdu.",
        "confirm_delete_pin": "Supprimer le repère « {label} » ?",
        "confirm_revoke_availability": "Révoquer cette fenêtre de disponibilité ?",
        "floorplan_revoke": "Révoquer",
        ...
        "download_failed": "Échec du téléchargement — réessayez, ou contactez l'informatique si cela persiste",
        "download_failed_missing": "Échec du téléchargement — le fichier est introuvable sur le serveur",
        ...
        "kind_other": "Autre",
        "delete_confirm": "Supprimer définitivement cette ressource retirée et ses réservations passées ? Action irréversible.",
        "migrate_bookings_title": "Migrer les réservations de {name}",
        "migrate_bookings_hint": "Cette ressource a encore des réservations à venir. Choisissez une ressource de remplacement pour chacune ; elles seront déplacées (et leurs utilisateurs notifiés) avant la suppression.",
        "migrate_target": "Déplacer vers",
        "migrate_select_all": "Choisissez une ressource de remplacement pour chaque réservation",
        "migrate_and_delete": "Migrer et supprimer",
        "migrate_no_target": "Aucune autre ressource active disponible — annulez d'abord les réservations",
        "bookings_migrated_resource_deleted": "Réservations migrées, ressource supprimée",
        "note": "Note",
